  ...
  return (
    <section id="skills" className="py-20 px-4 relative">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Methodology Section */}
        <Animate animation="fadeInUp" delay={0.35} className="mt-20">
          <div className="p-8 md:p-12 rounded-xl bg-gradient-to-br from-cyber-dark to-black border border-cyber-border hover-lift">
