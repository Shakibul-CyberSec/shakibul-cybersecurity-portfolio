    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-16">
      <div className="max-w-6xl mx-auto text-center">
        <div className="space-y-8">
          {/* Badge - Smooth entrance with professional timing */}
          <Animate animation="scaleIn" delay={0.1}>
          ...
          {/* Subtitle - Delayed for better flow */}
          ...
          {/* Stats Grid - Staggered with longer delays */}
          <Stagger stagger={0.12} className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto pt-4">
            {[
          ...
          {/* CTA Buttons - Final element with appropriate delay */}
          <Animate animation="fadeInUp" delay={0.7}>
          ...
          {/* Scroll Indicator - Subtle final element */}
          <Animate animation="fadeIn" delay={0.9}>
            <div className="pt-16 opacity-70 hover:opacity-100 transition-opacity duration-300">
              <div className="text-cyber-gray text-sm font-mono mb-2">Scroll to explore</div>
              <div className="w-px h-12 bg-gradient-to-b from-neon-green via-neon-cyan to-transparent mx-auto animate-pulse" />
            </div>
          </Animate>
        </div>
      </div>
